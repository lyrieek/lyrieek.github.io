  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      $.each(data, function(i, item) {
        html += "<div style='cursor:pointer;font-weight:bolder;color:" + china[item.AreaName]['path'].color +
          "' title='" + china[item.AreaName]['name'] +
      ...
      $("#topList").html(html).find("div").click(function() {
        ...
        $(this).siblings().css("font-size", "").removeAttr("select").end().css("font-size", "20px").attr(
          "select", "");
        ////显示省份明细，自己修改
